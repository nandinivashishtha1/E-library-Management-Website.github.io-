...
if(!empty($bookname) ||!empty($authorname) || !empty($unique_book_no) ){
    ...
    $sql= "DELETE FROM addbook WHERE Book_Name='$bookname' ";
    
    if(mysqli_query($conn,$sql)){
     echo "<center><h1>Record deleted succesfully</center></h1>";
    }
    else{
    ...
    echo "<center><h1>All fields are required</center></h1>";
    die();
}
